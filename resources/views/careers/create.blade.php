...
<section class="lg:py-24 md:py-12 sm:py-4 relative">
    <div class="max-w-3xl lg:w-1/2 px-4 md:px-5 lg:px-5 mx-auto"> <!-- max-w-7xlをmax-w-3xlに変更し、lg:w-1/2を削除 -->
        <div class="w-full flex-col justify-center items-center lg:gap-14 md:gap-10 gap-8 inline-flex"> <!-- justify-startをjustify-centerに、items-startをitems-centerに変更 -->
            <div class="w-full flex-col justify-center items-center gap-6 flex"> <!-- justify-startをjustify-centerに、items-startをitems-centerに変更 -->
                <h4 class="text-gray-900 text-xl font-semibold leading-loose">基本情報の登録</h4>

                <div class="w-full flex-col justify-center items-center gap-8 flex"> <!-- justify-startをjustify-centerに、items-startをitems-centerに変更 -->
                    <div class="w-full justify-center items-center gap-8 flex sm:flex-row flex-col"> <!-- justify-startをjustify-centerに、items-startをitems-centerに変更 -->
                        <form action="{{ route('careers.store') }}" method="POST" class="w-full"> <!-- class="w-full"を追加 -->
                            @csrf
                            <!-- 基本情報 -->
                            ...
                            <div id="working-fields" style="display: none;">
                                ...
                                <!-- 年収 -->
                                <div>
                                    <label for="annual_income">現在の年収</label>
                                ...
                                <div class="w-full justify-start items-start gap-8 flex sm:flex-row flex-col">
                                    <div class="w-full justify-start items-start gap-8 flex sm:flex-row flex-col">
                                        <div class="w-full flex-col justify-start items-start gap-1.5 flex">
                                            ...
                                            <select id="job_change_motivation" name="job_change_motivation_id"
                                                required
                            ...
                            <div id="student-fields" style="display: none;">
                                ...
                                <div class="w-full flex-col justify-start items-start gap-1.5 flex">
                                    ...
                                    <input type="text" id="college_faculty" name="college_faculty" required
                                        class="w-full focus:outline-none text-gray-900 placeholder-gray-400 text-sm font-normal leading-relaxed px-4 py-2 rounded-md shadow-sm border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                                ...
                                <div class="w-full flex-col justify-start items-start gap-1.5 flex">
                                    ...
                                    <input type="text" id="college_department" name="college_department" required
                                        class="w-full focus:outline-none text-gray-900 placeholder-gray-400 text-sm font-normal leading-relaxed px-4 py-2 rounded-md shadow-sm border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
